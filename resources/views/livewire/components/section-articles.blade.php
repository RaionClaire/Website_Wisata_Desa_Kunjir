  ...
  <div class="max-w-7xl mx-auto px-4">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        @foreach($latestArticles as $article)
          @include('livewire.components.card-article',[
            'article' => $article,
            'image' => $article->thumbnail_path ? asset('storage/' . $article->thumbnail_path) : '/images/kunjir_pantai_1.jpeg',
            'title' => $article->title,
    ...
    @else
      <div class="text-center py-12">
        ...
        <a href="{{ route('articles.index') }}" class="inline-block mt-4 text-green-700 font-medium hover:underline">
          Cek halaman artikel →
        </a>
      </div>
    @endif

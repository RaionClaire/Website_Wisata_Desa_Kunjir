...
<section id="weather-forecast" class="relative bg-cover bg-center bg-no-repeat mt-20"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20">
                    ...
                    @foreach ($weatherData['daily']['time'] as $index => $date)
                        ...
                        <div class="group relative">
                            <div class="bg-[#22446c] bg-opacity-50 rounded-xl p-4 border border-white shadow-md w-full">
                                @if ($isToday)
                                    <div
                                        class="absolute -top-3 -right-3 bg-gradient-to-r from-cyan-400 to-teal-400 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">
                                        Hari Ini
                                    </div>
                                @endif
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="mb-3">
                                        <span
                                            class="text-4xl font-bold text-white drop-shadow-lg">{{ $maxTemp }}°</span>
                                        <span class="text-xl text-cyan-200">/ {{ $minTemp }}°</span>
                                    </div>

                                    <!-- Weather Description -->
                                    <div
                                        class="inline-block bg-white bg-opacity-20 backdrop-blur-sm px-4 py-2 rounded-full">
        ...
        @else
            <div
                class="text-center py-16 bg-white bg-opacity-10 backdrop-blur-lg rounded-3xl border border-white border-opacity-20">
                <svg class="w-16 h-16 mx-auto mb-4 text-cyan-300" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
